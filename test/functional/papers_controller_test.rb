...
class PapersControllerTest < ActionController::TestCase
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post :create, paper: { assignment_id: @paper.assignment_id, file: @paper.file, name: @paper.name }
    end
  ...
  test "should update paper" do
    put :update, id: @paper, paper: { assignment_id: @paper.assignment_id, file: @paper.file, name: @paper.name }
    assert_redirected_to paper_path(assigns(:paper))
  end
